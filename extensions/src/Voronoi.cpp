...
using vorType=boost::polygon::voronoi_diagram<double>;
...
void Vor::compute()
{
    boost::polygon::construct_voronoi( point_data_.begin(), point_data_.end(),segment_data_.begin(),segment_data_.end(), &vd_ );
}

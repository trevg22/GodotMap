...
void Voronoi::addVertex(const godot::Vector2 &point) {}
...
void Voronoi::_bind_methods() {
  godot::ClassDB::bind_method(godot::D_METHOD("addVertex"),
                              &Voronoi::addVertex);
  godot::ClassDB::bind_method(godot::D_METHOD("compute"), &Voronoi::compute);
  godot::ClassDB::bind_method(godot::D_METHOD("getPolygons"),
                              &Voronoi::getPolygons);
}

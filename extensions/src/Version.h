...
// #if EXTENSIONS_VERSION < EXTENSIONS_VERSION_CHECK(2, 1, 0)
//     // do stuff
// #endif
//
// Returns an integer which may be used in comparisons
#define EXTENSIONS_VERSION_CHECK( major, minor, patch ) ( ((major)<<16) | ((minor)<<8) | (patch) )

#define EXTENSIONS_VERSION_MAJOR  0
#define EXTENSIONS_VERSION_MINOR  1
#define EXTENSIONS_VERSION_PATCH  0
...
#define EXTENSIONS_VERSION  EXTENSIONS_VERSION_CHECK( 0, 1, 0 )
...
namespace VersionInfo {
    ...
    constexpr std::string_view VERSION_STR = "extensions HEAD-HASH-NOTFOUND";
